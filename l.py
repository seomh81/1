...
def start_monitoring():
    try:
        ...
        while True:
            ...
            for account in accounts:
                for ticker in tickers:
                    if account['market'] == ticker['market']:
                        ...
                        # 개별 종목 1% 이상 상승 시 메세지 발송(1시간 간격)
                        if Decimal(str(chg_rate)) >= Decimal(str(1)):
            ...
            # 전체 자산 1%이상 상승 시 메세지 발송
            if Decimal(str(overall_revenue)) >= Decimal(str(1)):
