            ...
            for target_item in target_items:
                for ticker in tickers:
                    ...
                    if target_item['market'] == ticker['market']:
                        ...
                        # 캔들 조회 + BB 조회
                        # ------------------------------------------------------------------
                        candles = upbit.get_candle(target_item['market'], '3', 50)
                        df_bb = upbit.get_bb(target_item['market'], '10', '200', 1)  # 15분봉으로 테스트

                        #can_tradeNow = candles[0]['trade_price']
                        #can_highNow = candles[0]['high_price']
                        can_lowNow = candles[0]['low_price']

                        #bb_now = df_bb[0]['BBH']
                        #bb_Before1 = df_bb[1]['BBH']
                        #bb_Before2 = df_bb[2]['BBH']
                        bb_sell = df_bb[0]['BBM']
