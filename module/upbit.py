...
def buycoin_mp(target_item, buy_amount):
    try:
        ...
        jwt_token = jwt.encode(payload, 'tqakzE54kMVviOZGwx4icd4jPqyAAOJQVpRfKNAm')#.decode('utf8')
        authorize_token = 'Bearer {}'.format(jwt_token)
        headers = {"Authorization": authorize_token}
...
def get_accounts(except_yn, market_code):
    try:
        ...
        jwt_token = jwt.encode(payload, 'tqakzE54kMVviOZGwx4icd4jPqyAAOJQVpRfKNAm')
        authorize_token = 'Bearer {}'.format(jwt_token)
        headers = {"Authorization": authorize_token}
