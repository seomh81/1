...
<template>
  <v-card width="360" class="mt-3 noticeCard" elevation="0" rounded="lg">
    <v-toolbar color="transparent" density="comfortable">
      <v-toolbar-title class="largeBoldText">문의하기</v-toolbar-title>
      <v-spacer></v-spacer>
      <v-card-actions>
    ...
    <v-container class="py-5">
      <v-row>
        <v-col cols="12" class="d-flex justify-space-between align-center">
          <p class="noticeText">고장 신고</p>
          <p class="text-disabled">1577-0603</p>
        </v-col>
        <v-col cols="12" class="d-flex justify-space-between align-center">
          <p class="noticeText">영업소</p>
          <p class="text-disabled">02-1234-5678</p>
        </v-col>
      </v-row>
    </v-container>
  </v-card>
