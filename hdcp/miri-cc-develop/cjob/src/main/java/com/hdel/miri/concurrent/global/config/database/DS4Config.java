...
@Slf4j
@Configuration
@MapperScan(basePackages = {"com.hdel.miri.concurrent.domain.hccc"}
...
public class DS4Config {
    ...
    public SqlSessionTemplate ds3SqlSessionTemplate(@Qualifier("ds4SqlSessionFactory") SqlSessionFactory sqlSessionFactory) {
