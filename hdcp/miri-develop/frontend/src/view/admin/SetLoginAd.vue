...
const apiList = {
  getList: {
    url: "/v2/ad/signin/list",
    method: "get",
    queryparam: {},
  },
  createList: {
    url: "/v2/ad/signin/create",
    method: "post",
    queryparam: {},
  },
  updateList: {
    url: "/v2/ad/signin/update",
    method: "post",
    queryparam: {},
  },
  removeList: {
    url: "/v2/ad/signin/remove",
    method: "post",
    queryparam: {},
  },
  active: {
    url: "/v2/ad/signin/active",
    method: "post",
    queryparam: {},
  },
  inactive: {
    url: "/v2/ad/signin/inactive",
    method: "post",
    queryparam: {},
  },
  getImages: {
    url: "/v2/ad/signin/details",
    method: "get",
    queryparam: {},
  },
  uploadImages: {
    url: "/v2/ad/signin/details/create",
    method: "post",
    headers: {
  ...
  deleteImage: {
    url: "/v2/ad/signin/detail/delete",
    method: "post",
    queryparam: {},
  },
};
      ...
      >
        <v-container>
          <v-row>
            ...
            <v-col cols="6" v-for="(item, arr, i) in ImageData" :key="i">
              <v-card rounded="lg" class="customCard">
                <v-toolbar density="compact" color="white">
                  <v-toolbar-title>{{ item.originalFileName }}</v-toolbar-title>
                  <v-spacer></v-spacer>
                  <v-btn
                    icon="mdi-close"
                    @click="
