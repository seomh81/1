...
@MapperScan(
        basePackages = {
                "com.hdel.miri.api.domain.auth"
                ,"com.hdel.miri.api.domain.user"
                ,"com.hdel.miri.api.domain.masterdata"
                ,"com.hdel.miri.api.domain.notice"
                ,"com.hdel.miri.api.domain.storage"
                ,"com.hdel.miri.api.domain.faq"
                ,"com.hdel.miri.api.domain.privilege.vue"
                ,"com.hdel.miri.api.domain.privilege.view"
                ,"com.hdel.miri.api.domain.privilege.menu"
                ,"com.hdel.miri.api.domain.privilege.func"
                ,"com.hdel.miri.api.domain.privilege.role"
                ,"com.hdel.miri.api.domain.privilege.policy"
                ,"com.hdel.miri.api.domain.ad.video"
                ,"com.hdel.miri.api.domain.ad.popup"
                ,"com.hdel.miri.api.domain.ad.signin"
                ,"com.hdel.miri.api.domain.ad.section"
                ,"com.hdel.miri.api.domain.terms"
                ,"com.hdel.miri.api.domain.setup"
                ,"com.hdel.miri.api.domain.portfolio"
                ,"com.hdel.miri.api.domain.contract"
                ,"com.hdel.miri.api.domain.alarm"
                ,"com.hdel.miri.api.domain.logging"
                ,"com.hdel.miri.api.domain.cc"
        }
