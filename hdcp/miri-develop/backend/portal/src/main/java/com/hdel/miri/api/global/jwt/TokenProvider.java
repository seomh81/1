...
public class TokenProvider {
    ...
    // private final long accessTokenExpired = 1000*10 ; //2시간 - 변경예정;
    // private final long refreshTokenExpired = 1000*1000; //24시간 - 변경예정;
    private final long accessTokenExpired = 1000*60*60*2 ; //2시간 - 변경예정;
    private final long refreshTokenExpired = 1000*60*60*24; //24시간 - 변경예정;
