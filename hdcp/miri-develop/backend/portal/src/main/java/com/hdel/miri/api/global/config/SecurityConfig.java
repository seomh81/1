...
import com.hdel.miri.api.domain.auth.CustomUserDetailService;
import com.hdel.miri.api.global.jwt.JwtAccessDeniedHandler;
import com.hdel.miri.api.global.jwt.JwtAuthenticationEntryPoint;
import com.hdel.miri.api.global.jwt.JwtFilter;
    ...
    protected SecurityFilterChain configure(HttpSecurity http) throws Exception {
            return http
                ...
                .authorizeRequests()
                    ...
                    .antMatchers(
                        openURIConfig.getOpenTokenURIs()).permitAll()
