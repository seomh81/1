...
def start_selltrade(sell_pcnt, dcnt_pcnt):
    try:
        ...
        while True:
            ...
            tickers = target_items_comma
            #tickers = upbit.get_ticker(target_items_comma)
            #print(target_items)
            #print(target_items_comma)
            print(tickers)
                ...
                for ticker in tickers:
                    ...
                    try:
                        if target_item['market'] == ticker:
                            ...
                            # 캔들 조회
                            # ------------------------------------------------------------------
                            candles = oldupbit.get_candle(target_item['market'], 'D', 200)
...
if __name__ == '__main__':
    ...
    try:
        ...
        dcnt_pcnt = -0.2 #input("고점대비 하락률(ex:-1%=-1) : ")
