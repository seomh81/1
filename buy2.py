    ...
    try:
        ...
        while True:
            ...
            for target_item in target_items:
                ...
                # -------------------------------------------------------------
                indicators = upbit.get_indicator_sel(target_item['market'], '60', 200, 41,
                                                     ['BB', 'BB2', 'CANDLE'])
                ...
                if bb[0]['BBH'] < candle[0]['high_price'] and all(bb[i+1]['BBH'] > candle[i+1]['high_price'] for i in range(20)): #보관, 왜 매수가 안될까? 원복하자
